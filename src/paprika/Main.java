...
import paprika.neo4j.ARGB8888Query;
import paprika.neo4j.InitOnDrawQuery;
import net.sourceforge.argparse4j.inf.Subparser;
import paprika.neo4j.UnsupportedHardwareAccelerationQuery;
import net.sourceforge.argparse4j.inf.Namespace;
import paprika.neo4j.HashMapUsageQuery;
import paprika.neo4j.InvalidateWithoutRectQuery;
import java.util.logging.Logger;
import paprika.analyzer.Analyzer;
import java.io.InputStream;
import paprika.neo4j.UnsuitedLRUCacheSizeQuery;
import paprika.neo4j.LICQuery;
import paprika.neo4j.QueryEngine;
import paprika.neo4j.TrackingHardwareIdQuery;
import paprika.neo4j.HeavyBroadcastReceiverQuery;
import paprika.analyzer.SootAnalyzer;
import net.sourceforge.argparse4j.inf.ArgumentParserException;
import paprika.neo4j.HeavyAsyncTaskStepsQuery;
import paprika.neo4j.LMQuery;
...
import paprika.neo4j.HeavyServiceStartQuery;
import paprika.neo4j.ModelToGraph;
import paprika.neo4j.MIMQuery;
import codesmells.annotations.CC;
import paprika.neo4j.CCQuery;
import net.sourceforge.argparse4j.inf.Subparsers;
import paprika.neo4j.IGSQuery;
import paprika.neo4j.NLMRQuery;
import paprika.neo4j.SAKQuery;
import java.security.NoSuchAlgorithmException;
import java.util.Calendar;
import java.util.GregorianCalendar;
import java.security.MessageDigest;
import paprika.neo4j.OverdrawQuery;
...
public class Main {
    ...
    private static String computeSha256(String path) throws IOException, NoSuchAlgorithmException {
        ...
        for (int i = 0; i < (hashValue.length); i++) {
            sb.append(Integer.toString((((hashValue[i]) & 255) + 256), 16).substring(1));
        }
        return sb.toString();
    }
    ...
    public static void checkArgs(Namespace arg) throws Exception {
        String sha256 = Main.computeSha256(arg.getString("apk"));
    ...
    public static void runAnalysis(Namespace arg) throws Exception {
        ...
        Analyzer analyzer = new SootAnalyzer(arg.getString("apk"), arg.getString("androidJars"), arg.getString("name"), arg.getString("key").toLowerCase(), arg.getString("package"), arg.getString("date"), arg.getInt("size"), arg.getString("developer"), arg.getString("category"), arg.getString("price"), arg.getDouble("rating"), arg.getString("nbDownload"), arg.getString("versionCode"), arg.getString("versionName"), arg.getString("sdkVersion"), arg.getString("targetSdkVersion"), arg.getBoolean("onlyMainPackage"));
        analyzer.init();
